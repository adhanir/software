...
$books = array(
    1 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2001',
        'sinopsis' => 'Dhimas dan Ruben adalah dua orang mahasiswa yang tengah menuntut ilmu di negeri Paman Sam. 
        ...
        Satu masterpiece. Satu tulisan atau riset yang membantu menjembatani semua percabangan sains. Roman yang berdimensi luas dan mampu menggerakkan hati banyak orang.'
        
    ),
    
    2 => array(
        'judul' => 'Supernova 2: Akar',
        'isbn' => '9799625726',
        'kategori' => 'Fiksi Ilmiah',
        'pengarang' => 'Dee Lestari',
        'penerbit' => 'Bandung: Truedee Books',
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2002',
        'sinopsis' => 'Di Bolivia, Gio mendapat kabar bahwa Diva hilang dalam sebuah ekspedisi sungai di pedalaman Amazon. 
    ...
    3 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2012',
        'sinopsis' => 'naknya mengundang pertentangan dari keluarganya sendiri.
    ...
    4 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2006',
        'sinopsis' => 'Pemaknaan kembali kembali kopi, Buddha, Herman, surat tak tarkirimkan, cinta sejenis yang manis atau apa pun, membuktikan Dee tetap memesona.
    ...
    5 => array(
        ...
        'bahasa' => 'Inggris',
        'tahunterbit' => '2005',
        'sinopsis' => 'Drawing on cutting-edge neuroscience and psychology and displaying all of the brilliance that made The Tipping Point a classic, Blink changes the way you ll understand every decision you make.
    ...
    6 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '1980',
        'sinopsis' => 'Roman Tetralogi Buru mengambil latar belakang dan cikal bakal nation Indonesia di awal abad ke-20. Dengan membacanya waktu kita dibalikkan 
    ...
    7 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2005',
        'sinopsis' => 'Begitu banyak hal menakjubkan yang terjadi dalam masa kecil para anggota Laskar Pelangi. Sebelas orang anak Melayu Belitong yang luar biasa ini tak menyerah walau keadaan tak bersimpati pada mereka.
        ...
        dan tersentuh saat membaca setiap lembarnya. Buku ini dipersembahkan buat mereka yang meyakini the magic of childhood memories, dan khususnya juga buat siapa saja yang masih meyakini adanya pintu keajaiban lain untuk mengubah dunia: pendidikan.'
    ),
    ...
    8 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2009',
        'sinopsis' => 'Alif lahir di pinggir Danau Maninjau dan tidak pernah menginjak tanah di luar ranah Minangkabau. Masa kecilnya adalah berburu durian runtuh di rimba Bukit Barisan, bermain bola di sawah berlumpur dan tentu mandi berkecipak di air biru Danau Maninjau.
        ...
        Kenapa mereka harus botak berkilat-kilat? Bagaimana sampai Icuk Sugiarto, Arnold Schwarzenegger, Ibnu Rusyd, bahkan Maradona sampai akhirnya ikut campur? Ikuti perjalanan hidup yang inspiratif ini langsung dari mata para pelakunya. Negeri Lima Menara adalah buku pertama dari sebuah trilogi.'
    ),
    ...
    9 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2005',
        'sinopsis' => 'Lima sahabat telah menjalin persahabatan selama tujuh tahun. Mereka adalah Arial yang paling tampan, Riani sebagai satu-satunya wanita dalam kelompok itu, Zafran yang berlagak seperti seorang penyair, Ian yang paling subur badannya, dan Genta yang dianggap sebagai leader dalam kelompok itu.
    ...
    11 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2011',
        'sinopsis' => 'Tiga sahabat. Satu pertanyaan. What if in the person that you love, you find a best friend instead of a lover?
    ...
    12 => array(
        'judul' => 'Originals: How Non-Conformists Move the World',
        'isbn' => '0525429565',
        'kategori' => 'Bisnis',
        'pengarang' => 'Adam M. Grant',
        'penerbit' => 'Viking',
        'bahasa' => 'Inggris',
        'tahunterbit' => '2001',
        'sinopsis' => 'In Originals the author addresses the challenge of improving the world from the perspective of becoming original: choosing to champion novel ideas and values that go against the grain, battle conformity, and buck outdated traditions. How can we originate new ideas, policies, and practices without risking it all?
        ...
        and a TV executive who didn’t even work in comedy but saved Seinfeld from the cutting-room floor. The payoff is a set of groundbreaking insights about rejecting conformity and improving the status quo.'
    ),
    ...
    13 => array(
        ...
        termasuk atas penyelewengan kalau isi dan makna buku kecil ini ternyata tidak mampu memenuhi tujuan utamanya: membuat anda tersenyum dan tertawa!" Toto Rahardjo, penyunting'
    ),
    ...
    14 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2005',
        'sinopsis' => 'Sebuah buku tentang kesaksian. Dan buku ini adalah kesaksian tentang peristiwa genosida kemanusiaan paling mengerikan di balik pembangunan Jalan Raya Pos atau yang lebih dikenal dengan Jalan Daendels;
    ...
    15 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2014',
        'sinopsis' => '“Hai, Satya! Hai, Cakra!” Sang Bapak melambaikan tangan.
        “Ini Bapak.
    ...
    16 => array(
        'judul' => 'Invent and Wander: The Collected Writings of Jeff Bezos',
        'isbn' => '1647820715',
        'kategori' => 'Bisnis',
        'pengarang' => 'Walter Isaacson',
        'penerbit' => 'Harvard Business',
        'bahasa' => 'Inggris',
        'tahunterbit' => '2020',
        'sinopsis' => 'In this collection of Jeff Bezos’s writings—his unique and strikingly original annual shareholder letters,
        ...
        businesses will come to understand the principles that have driven the success of one of the most important innovators of our time.'
    ),
    
    17 => array(
        'judul' => 'The Pull of the Stars',
        'isbn' => '0316499013',
        'kategori' => 'Sejarah',
        ...
        'bahasa' => 'English',
        'tahunterbit' => '2020',
        'sinopsis' => 'In an Ireland doubly ravaged by war and disease, Nurse Julia Power works at an understaffed hospital in the city center,
    ...
    18 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2005',
        'sinopsis' => 'Delisa anak perempuan yang bermata hijau, bening dan umurnya baru mencecah lima tahun. Dia hidup dalam keluarganya yang sebegitu,
        ...
        dan dalam keadaan sebegitu apakah Delisa mampu tetap tersenyum seperti dahulu dan menyudahkan hafalannya?'
    ),
    ...
    19 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2010',
        'sinopsis' => 'Api Sejarah 2 merupakan jilid ke-2 dari buku bestseller Api sejarah yang mengungkap semua fakta yang tersembunyi dan disembungikan tentang mahakrya Ulama dan Santri dalam menegakkan NKRI.
    ...
    20 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2011',
        'sinopsis' => '"Ada cara yang menyenangkan untuk mengubah kepribadian Anda agar menjadi selevel para ksatria Islam yang terpisah zaman dan waktu, bacalah sejarah"
    ...
    22 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2015',
        'sinopsis' => 'Betapa Sabari menyayangi Zorro. Ingin dia memeluknya sepanjang waktu. Dia terpesona melihat makhluk kecil yang sangat indah dan seluruh kebaikan yang terpancar
    ...
    23 => array(
        ...
        'bahasa' => 'Indonesia',
        'tahunterbit' => '2016',
        'sinopsis' => '“Jam tiga dini hari, sweter, dan jalanan yang gelap dan sepi .... Ada peta, petunjuk; dan Jakarta menjadi tempat yang belum pernah kami datangi sebelumnya.”
