        ...
        <div class="modal-content">
            ...
            <form action="modules/kode-akses/tambah-kode-akses.php" method="post">
                ...
                <div class="modal-body">
                    ...
                    <?php 
                        $sql_transaksi = "SELECT transaksi_id, transaksi_penyewa_id FROM tb_transaksi WHERE transaksi_status = 1";
                    ...
                    <div class="form-group">
                        ...
                        <select name="transaksi_id" class="custom-select">
                            ...
                            <?php 
                                ...
                                $transaksi_penyewa_id = $data_transaksi['transaksi_penyewa_id'];
