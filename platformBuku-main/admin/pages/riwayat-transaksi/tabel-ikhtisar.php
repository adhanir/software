                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php 
                                        $transaksi_penyewa_id = $data_select_transaksi['transaksi_penyewa_id'];
                                    ...
                                    <?php 
                                        $transaksi_paket_id = $data_select_transaksi['transaksi_paket_id'];
                                    ...
                                    <?php 
                                        $transaksi_buku_id = $data_select_transaksi['transaksi_buku_id'];
