        ...
        <div class="col-md-8">
            ...
            <table class="table table-borderless">
                ...
                <?php 
                    ...
                    $sql_cek_transaksi = "SELECT transaksi_id FROM tb_transaksi WHERE buku_id = '$idbuku' AND penyewa_id = '$get_id_penyewa' AND transaksi_status = 0 OR transaksi_status = 2";
                    $get_transaksi_id = mysqli_fetch_assoc(mysqli_query($conn, $sql_cek_transaksi));
                ?>
                ...
                <tr>
                    ...
                    ?>
                        <select class="form-control" aria-label="Default select example">
                            ...
                            <option value="<?php echo $idpaket= $rowpaket['paket_id']; ?>"><?php echo $rowpaket['paket_nama']; ?> (<?php echo "Rp " . number_format($rowpaket['paket_harga'],2,',','.'); ?>)</option>
                            <?php endwhile; ?>
                        </select>
                    </td>
                </tr>
            ...
            <form action="detail_transaksi.php" method="POST" class="float-right">
                <input type="hidden" name="transaksi_id" value="<?php echo $get_transaksi_id['transaksi_id']; ?>">
