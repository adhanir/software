...
('K2012001', 'admin', 'admin@gmail.co.id', 'admin12345');
...
CREATE TABLE `tb_buku` (
  ...
  `buku_cover` varchar(17) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('PK01', 'SILVER', 3, 5000, 0),
('PK02', 'GOLD', 5, 7000, 0),
('PK03', 'DIAMOND', 7, 10000, 0),
('PK04', 'SUMMERSOLSTICE', 14, 15000, 0);
